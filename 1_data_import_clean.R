...
## 6.3: Aggregate to_level_4 Values -------
...
## 6.4: Filter to Just the Territories (municipalities) Within the Cerrado -------
...
## 6.5: Get Land Transition to Soy  -----
...
# 7: Export All df's to Use in Next Script -----
